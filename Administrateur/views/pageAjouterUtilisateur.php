<?php 
    ...
    require_once "../Administrateur/models/UtilisateurModel.php"; 
    require_once "../Administrateur/controllers/AjoutUtilisateurController.php"; 
?>
        ...
        <div id="gestion-utilisateurs">
            ...
            <form method="POST">
                ...
                <div style="display: flex; gap: 10px;">
                    ...
                    <a href="pageAdmin.php"><button type="button" style="background-color: var(--text-muted);">Annuler</button></a>
                </div>
            </form>
        </div>
    </main>
