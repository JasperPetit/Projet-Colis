<?php 
    ...
    require_once "../controllers/ModifierCommandeController.php"; 
?>
...
<body>
    ...
    <main>
        ...
        <form action="pageModifierCommande.php?modifier=<?= htmlspecialchars($commande['NumeroBonDeCommande']) ?>" method="POST">
            ...
            <div style="display: flex; gap: 10px;">
                ...
                <a href="pageMesCommandes.php" class="btn-reinitialiser" style="text-decoration: none;">
                    Annuler
                </a>
            </div>
        </form>
