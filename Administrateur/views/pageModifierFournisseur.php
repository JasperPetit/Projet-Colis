<?php 
    ...
    require_once "../controllers/ModifierFournisseurController.php"; 
...
<body>
    ...
    <main>
        ...
        <form action="pageModifierFournisseur.php?modifier=<?= $fournisseur['idFournisseur'] ?>" method="POST">
            ...
            <div style="display: flex; gap: 10px;">
                ...
                <a href="pageFournisseurs.php" class="btn-reinitialiser" style="text-decoration:none;">Annuler</a>
            </div>
        </form>
    </main>
</body>
