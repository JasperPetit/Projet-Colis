<?php 
    ...
    require_once "../Administrateur/controllers/FournisseurController.php"; 
?>
...
<body>
    ...
    <main>
        ...
        <a href="pageAjouterFournisseur.php" class="btn-nouvelle-commande">
            ...
            <?php foreach ($resFournisseurs as $fournisseur) { ?>
                <div class="section-fournisseur">
                    ...
                    <div class="details-fournisseur">
                        ...
                        <form method="POST" style="display: inline; margin: 0; padding: 0; border: none; background: none;" onsubmit="return confirmerSuppressionFournisseur('<?= htmlspecialchars($fournisseur['nomEntreprise']) ?>')">
